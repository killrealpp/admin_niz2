...
- Checks are green locally: compileall, MAX media/outbound/inbound/webhook smokes, `dialog_identity_smoke.py`, channel contract, media regression, read-only MAX status and safe live MAX upload-only check for `banya.jpg`.
